...
public class ProcessosMetricsPostgresRepository implements ProcessosMetricsRepository {

    private final Logger log = LoggerFactory.getLogger(ProcessosMetricsPostgresRepository.class);
