...
@Component
public class BuscaProcessosConclusosSgKafkaListener extends MessageListenerAbstract<ProcessoConcluso> {

    private final BuscaProcessosConclusos service;
    public static final String TOPIC_NAME =  "GABINETE_BUSCA_CONCLUSOS_SG";
    private final Logger logger = LoggerFactory.getLogger(BuscaProcessosConclusosSgKafkaListener.class);
    private final LocalizadorListener localizadorListener;

    @Autowired
    public BuscaProcessosConclusosSgKafkaListener(BuscaProcessosConclusos service,
    ...
    public void executa(ProcessoConcluso proc) throws Exception {
        try {
            ...
            throw new Exception("Erro ao processar importar processo concluso", e);
        }
    }
