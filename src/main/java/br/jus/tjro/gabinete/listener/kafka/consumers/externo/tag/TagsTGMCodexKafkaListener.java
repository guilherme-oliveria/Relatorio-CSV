...
@Configuration
@Profile("!test")
@ConditionalOnExpression("${KAFKA_ENABLE_RUNNER:true} && ${TGM_CODEX_ATIVADO:true}")
public class TagsTGMCodexKafkaListener extends MessageListenerAbstract<WrapperTagExterna> {

    private final ProcessoService processoService;
    private final ProcessoTagService processoTagService;
    private final LocalizadorService localizadorService;

    public static final String TOPIC_NAME =  "CODEX_TAG_PROCESSO";
    private final Logger logger = LoggerFactory.getLogger(TagsTGMCodexKafkaListener.class);

    @Autowired
    public TagsTGMCodexKafkaListener(ProcessoTagService processoTagService,
